...
public:
    ...
    virtual std::shared_ptr<SearchEngine> create_task_specific_SearchEngine(const std::shared_ptr<AbstractTask> &task, std::shared_ptr<ComponentMap> &component_map, int depth = -1);
};
